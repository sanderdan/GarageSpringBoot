...
-- VEHICLE
INSERT INTO Vehicle(id, license_plate, manufacturer, model, model_year)
...
INSERT INTO Vehicle(id, license_plate, manufacturer, model, model_year, fuel)
VALUES ('6', 'HHU453', 'OPEL', 'ASTRA', '2004', 'GASOLINE'),
('7', 'BOSS1N', 'BMW', 'M3', '2001', 'DIESEL');
INSERT INTO Vehicle(id, license_plate, manufacturer, fuel)
VALUES ('8', 'GGF432', 'MERCEDES', 'GASOLINE');
INSERT INTO Vehicle(id, license_plate, manufacturer, model)
VALUES ('9', 'HHD212', 'FORD', 'MONDEO'),
('11', 'LLP989','KIA','CEED'),
('12', 'KLM555','REANULT','LAGUNA');
INSERT INTO Vehicle(id, license_plate, manufacturer)
...
-- SERVICE
INSERT INTO Service(id, customer_id, vehicle_id, employee_id, service_date, service_status)
VALUES (1, 1, 1, 1, '2014-12-28 08:30:00.0', 'DONE'),
(2, 2, 7, 3, '2015-01-04 14:55:01.0', 'DONE');
